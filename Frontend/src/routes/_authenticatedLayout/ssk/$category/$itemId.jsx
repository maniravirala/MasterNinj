...
const SskItemDetails = () => {
  ...
  const item = essentialDetails.id === parseInt(itemId) ? essentialDetails : null;
    ...
    <PageParent title={item.name}>
      ...
      <div className="w-full space-y-4 sm:px-4 md:px-8 lg:px-16">
        <Image
          src={item.imgURL}
          alt={item.name}
          className="mx-auto mb-4 h-48 w-full rounded-lg object-cover sm:max-w-lg md:max-w-xl lg:max-w-2xl"
        />
