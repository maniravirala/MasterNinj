...
const ResumePreview = () => {
  ...
  const [selectedTemplate, setSelectedTemplate] = useLocalStorage("selectedTemplate", "Specialized1");
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center gap-4">
        <TemplatesSelectionModal tabsData={tabsData} selectedTemplate={selectedTemplate} setSelectedTemplate={setSelectedTemplate} />
        <SettingsModal />
      </div>

      <div id='resumePreview' className={`bg-white text-black ${getPaperClass()}`} style={{ margin: '0 auto', fontFamily: `${getFontFamilyClass()}` }}>
